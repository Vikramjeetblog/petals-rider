...
const mockNotifications = [
  { id: '1', title: 'New delivery assigned', time: '2 min ago', type: 'order' },
  { id: '2', title: 'Payout processed', time: '1 hour ago', type: 'payout' },
  { id: '3', title: 'Shift reminder', time: 'Today 7:00 AM', type: 'shift' },
];
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySub}>We’ll let you know when updates arrive.</Text>
          </View>
        )}
      />
    </SafeAreaView>
